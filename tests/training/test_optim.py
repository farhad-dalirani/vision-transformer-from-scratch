...
def test_get_adam_optimizer():
    ...
    optimizer = get_optimizer(net.parameters(), opt_name="adam", lr=0.1, betas=(0.8, 0.9), weight_decay=0.0)
...
def test_get_sgd_optimizer():
    ...
    optimizer = get_optimizer(net.parameters(), opt_name="sgd", lr=0.4, momentum=0.3, weight_decay=0.7)
